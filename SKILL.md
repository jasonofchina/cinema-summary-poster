...
**Reference: font-guide.md**

**Default Scheme (No special request):**
默认方案（用户无特殊要求时）：
- Title/Subtitle: **Songti (Serif) Regular** / 标题 / 小标题：**宋体 常规**
...
- User requests real person portrait: Explain limitations, suggest stylized/illustrated treatment / 用户要求添加现实人物肖像：说明生成限制，建议采用风格化或插画处理
